...
Functionally create a Calculator  as in the image above

### At the end of the project, following topics are to be covered;

- HTML Container,Digital_Clock
...
>>Part-1 HTML Structure
	...
	- Create a form (id="Digital_Clock")
